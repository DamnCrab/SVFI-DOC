...
| Algorithm Name | Applicable Materials | Requires BETA | Available on AMD GPUs |
| :---: | :---: | :---: | :---: |
| Anime4K | Anime |  | √ |
| AnimeSR | Anime |  | × |
| realCUGAN | Anime | | × |
...
| Codec | Use Hardware | Speed | Quality | File Size | Selection Suggestions |
| ------ | --------- | ---- | ---- | -------- | -------------------------------------------- |
...
::: warning If you are not familiar with compression, please keep the following rules in mind:
...
> <Badge text="Example"/> Custom compression parameters for CPU h265 compression:
>
...
::: warning
For anime materials, please try to enable [Forward Weighting](/en/pages/advanced-settings/#video-smoothness-optimization) in the **Video Smoothness Optimization** of the **Frame Interpolation Settings** as much as possible.
...
|------------|-------|-------|-------|------|
| Spatio-Temporal Linearization | Universal | ★★☆ | ★☆☆ | ☆☆☆ |
| Fixed Threshold De-Weighting | Universal | ★★★ | ★☆☆ | ☆☆☆ |
| Remove One Frame per Two | Anime | ★★★ | ★★☆ | ★☆☆ |
| Remove One Frame per Two and One Frame per Three | Anime | ★★★ | ★★☆ | ☆☆☆ |
| First-Order Difference De-Weighting | Anime | ★★☆ | ★★☆ | ★★☆ |
| Spatio-Temporal Resampling | Anime | ★★☆ | ★★★ | ★★★ |
| Forward De-Weighting | Anime | ☆☆☆ | ★★★ | ☆☆☆ |
| Cross Reconstruction | Anime | ★☆☆ | ★★★ | ☆☆☆ |
| Smooth Difference | Anime, One-time Restoration | / | / | / |
...
If you are not sure whether your video is one frame per two or one frame per three, please check [One Frame per N Introduction](https://www.zhihu.com/question/27781021).
...
These algorithms perform differently on different materials, and the algorithms and models for live-action and animation materials are respectively shown in [Presets](/en/pages/svfi-presets/) and the following introduction
...
When encoding, do not perform operations such as duplicate frame de-weighting
...
::: tip
Turning off auto error correction can improve the task initialization speed. It is recommended to turn off this option when processing queue tasks with stable settings
:::
