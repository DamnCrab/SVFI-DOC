---
title: 必读导引
permalink: /zh/pages/mustread/
---


**如您还未使用过软件，请阅读[新手教程](/zh/pages/svfi-quick-start/)**
...
若在软件使用过程中遇到问题，请阅读[常见问题解决](/zh/pages/QA/)
...
若要研究如何使用SVFI的命令行版本，或实现软件多开，软件版本保存等功能，请阅读[命令行程序进阶讲解](/zh/pages/svfi-cli/)
