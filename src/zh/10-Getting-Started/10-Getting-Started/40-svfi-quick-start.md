...
对图片序列补帧同理，只需将输入视频替换为存放图片序列的文件夹，并在`基础设置`指定图片序列的输入帧率。
:::

欢迎使用Squirrel Video Frame Interpolation补帧软件。此软件致力于将卡顿的低帧率视频处理为流畅的高帧率视频。
...
- 恭喜您已经完成了所有必要设置，现在点击❺**一键补帧**，就可以去泡杯咖啡，在输出文件夹等待输出结果。
  ...
  - 如果软件还是不幸发生错误，或者你没在输出文件夹看到期望的输出视频，请移步[常见问题解答](/zh/pages/QA/)获取可能的解决方案；
  - 如果此页内未列出相应问题的解决方案，请在[Steam讨论区](https://steamcommunity.com/app/1692080/discussions)或在软件内的互助论坛发帖以联系开发人员帮助解决。
